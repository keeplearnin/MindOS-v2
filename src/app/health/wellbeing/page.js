...
import { Heart, Calendar, TrendingUp, Flame, BookOpen, Zap, ClipboardCheck, ArrowRight } from 'lucide-react';
    ...
    <div className="max-w-4xl animate-in">
      <div className="mb-6">
        ...
        <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>
          Mood, energy, and journaling insights
        </p>
      </div>
      ...
      {/* Habits, metrics and BP live in the Tracker now */}
      <Link
        href="/health/tracker"
        className="card flex items-center gap-3 mt-4 mb-6"
        style={{ padding: '12px 16px' }}
      >
        <ClipboardCheck size={16} className="shrink-0" style={{ color: 'var(--text-muted)' }} />
        <span className="flex-1 text-sm" style={{ color: 'var(--text-secondary)' }}>
          Daily habits, metrics, and blood pressure moved to the Tracker
        </span>
